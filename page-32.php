							...
							<div class="flip-card">
								<div class="flip-card-inner">
									<div class="flip-card-front">
										<img src="<?php echo esc_url( $structure_one_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_one_image['alt'] ); ?>" />
									</div>
									<div class="flip-card-back gold">
										<div class="structure-info red text-start">
											<h2 class="card-title"><?php echo esc_html_e($structure_one_title); ?></h2>
											<p class="card-text"><?php echo esc_html_e($structure_one_body); ?></p>
										</div>
									</div>
									<img src="<?php echo esc_url( $structure_one_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_one_image['alt'] ); ?>" class="flip-card-img" />
								</div>
							</div>
							<?php endwhile; ?>
						<?php endif; ?>
					...
					<?php while( have_rows('corporate_structure') ): the_row(); ?>
						...
						<?php if( have_rows('structure_two') ): ?>
							...
							<div class="flip-card">
								<div class="flip-card-inner">
									<div class="flip-card-front">
										<img src="<?php echo esc_url( $structure_two_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_four_image['alt'] ); ?>" />
									</div>
									<div class="flip-card-back gold">
										<div class="structure-info blue text-start">
											<h2 class="card-title"><?php echo esc_html_e($structure_two_title); ?></h2>
											<p class="card-text"><?php echo esc_html_e($structure_two_body); ?></p>
										</div>
									</div>
									<img src="<?php echo esc_url( $structure_two_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_two_image['alt'] ); ?>" class="flip-card-img" />
								</div>
							</div>
							<?php endwhile; ?>
						<?php endif; ?>
					...
					<?php while( have_rows('corporate_structure') ): the_row(); ?>
						...
						<?php if( have_rows('structure_three') ): ?>
							...
							<div class="flip-card">
								<div class="flip-card-inner">
									<div class="flip-card-front">
										<img src="<?php echo esc_url( $structure_three_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_three_image['alt'] ); ?>" />
									</div>
									<div class="flip-card-back green">
										<div class="structure-info green text-start">
									...
									<img src="<?php echo esc_url( $structure_three_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_three_image['alt'] ); ?>" class="flip-card-img" />
								</div>
							</div>
							<?php endwhile; ?>
						<?php endif; ?>
					...
					<?php while( have_rows('corporate_structure') ): the_row(); ?>
						...
						<?php if( have_rows('structure_four') ): ?>
							...
							<div class="flip-card">
								<div class="flip-card-inner">
									<div class="flip-card-front">
										<img src="<?php echo esc_url( $structure_four_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_four_image['alt'] ); ?>" />
									</div>
									<div class="flip-card-back gold">
										<div class="structure-info gold text-start">
									...
									<img src="<?php echo esc_url( $structure_four_image['url'] ); ?>" alt="<?php echo esc_attr( $structure_four_image['alt'] ); ?>" class="flip-card-img" />
								</div>
							</div>
							<?php endwhile; ?>
						<?php endif; ?>
