												...
												<div class="card-img-container col-12 col-md-4">
													...
													<div class="solutions-icon">
														...
														<?php elseif($solutionClass === 'blub'): ?>
															<div class="solutions-icon"><div class="live-icon <?php echo $solutionClass; ?> livicon-evo-holder" style="visibility: visible; width: 100px;"><div class="lievo-svg-wrapper"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xml:space="preserve" data-animoptions="{'duration':'0.7', 'repeat':'2', 'repeatDelay':'0'}" preserveAspectRatio="xMinYMin meet" style="left: 0.5px; top: 0.375px;"><g class="lievo-setrotation"><g class="lievo-setsharp"><g class="lievo-setflip"><g class="lievo-main">
		...
		<?php 
				...
				if( $posts ): ?>	
					<?php foreach( $posts as $post ): 
							...
							?>
						<div class="promos container-fluid justify-content-around text-center" style="background-image:url('<?php the_field('promo_image'); ?>')">
						<div class="row">
							<div class="col-12">
