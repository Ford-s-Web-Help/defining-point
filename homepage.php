	...
	<div class="solutions box">
		...
		<div class="solutions-container">
			...
			?>
				...
				<div class="solutions-icon">
					<div class="livicon-evo" data-options=" name: camcoder.svg; style:
					lines;
