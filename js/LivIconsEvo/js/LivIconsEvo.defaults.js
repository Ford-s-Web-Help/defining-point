...
function LivIconsEvoDefaults () {
	...
	var defaultOptions = {
		/*
		The path from the root directoty of your site to the folder with SVG files of icons.
		If you upload the "LivIconsEvo" folder to the root directory of your site on the server,
		the value of the "pathToFolder" option should be
		either '/LivIconsEvo/svg/'
		or 'http://www.your_site.com/LivIconsEvo/svg/'
		or 'https://www.your_site.com/LivIconsEvo/svg/' if you're using encryption.
		...
		*/
		...
		colorsOnHover: 'darker', //'none', 'lighter', 'darker', 'custom' or 'hue0' ... 'hue360'
